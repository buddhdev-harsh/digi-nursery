 ...
 while($row = mysqli_fetch_array($result)){
					...
					<div class="squarecards" style="width:18%;height: 15%; float: left;margin-left: -30px; ">	
						<div class="card" style="width: 80%; height: 30%; margin-left: 20px; float: left;">
							...
							<div class="price" style="width: 30%; height: 7%; margin-bottom: 30px; padding: 10px;text-align: left;">
							...
							<a href="item.php?id=<?php echo $row['id'];?>" style="background-color: white;
  border: 1px solid black;
  border-radius: 5px;
  padding:10px;
  text-decoration: none;">See More...</a> <input type="submit" name="add_to_cart" style=" background-color: white;
  border: 1px solid black;
  border-radius: 5px;
  padding:10px;
" value="cart"></form>
